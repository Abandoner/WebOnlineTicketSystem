...
function check()
{
  if((document.test.starttime.value==null)||(document.test.starttime.value.length==0))
  {   
    alert("发车时间为空，请重新输入");
    document.test.starttime.focus();
    return false;
  } 
	if((document.test.waittime.value==null)||(document.test.waittime.value.length==0))
  {   
    alert("候车时间为空，请重新输入");
    document.test.waittime.focus();
    return false;
  }
  if((document.test.shunxu.value==null)||(document.test.shunxu.value.length==0))
  {   
    alert("第几站为空，请重新输入");
...
<form  method="post" action="tra_sta_stasvlt" name=test onSubmit="return check()">
  ...
  <tr>
    <td>候车时间</td>
    <td> <input name="waittime" type="text"  id="waittime" ></td>
  </tr>
   <tr>
    <td>第几站</td>
    <td><input name="shunxu" type="text"  id="shunxu" ></td>
  </tr>
