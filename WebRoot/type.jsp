...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="cs" lang="cs">
 ...
 <jsp:useBean id="type" scope="page" class="bean.type"/> 
  <body>
      ...
      <div id="container" class="box">
        ...
        <div id="obsah" class="content box">
          <div class="in">
            ...
            <h2>火车类型</h2>
      <h3><a href="addtype.jsp">新增类型</a></h3>
            <p>
<%
...
rs.absolute((Page-1)*pageSize+1); 
 ...
 name=rs.getString("name");
  ...
  %>
      ...
      <tr> 
        <td><%=typeid%></td>
        <td><%=name%></td>
        <td><a href="typesvlt?action=delete&typeid=<%=typeid%>">删除</a></td>
        <td><a href="updatetype.jsp?typeid=<%=typeid%> ">更新</a> </td>
      </tr>
      <% if(!rs.next())
		  break; 
  }
 ...
 <form action="type.jsp" method="get">
<%
if(Page!=1)
{out.print(" <a href=type.jsp?Page=1>第一页</a>");
out.print(" <a href=type.jspPage="+(Page-1)+">上一页</a>");
}
if(Page!=totalPage)
{
out.print(" <a href=type.jsp?Page="+(Page+1)+">下一页</a>");
out.print(" <a href=type.jsp?Page="+totalPage+">最后一页</a>");
}
%>
