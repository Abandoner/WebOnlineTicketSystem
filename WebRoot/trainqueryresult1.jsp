						...
						<div class="in">
							...
							<table width="100" border="1">
								...
								<tr>
									...
									<td><%=trainid%></td>
									<td>
										<a href="stationqueryresult.jsp?name4=<%=stationid%>"><%=stationid%></a>
									</td>
									<td><%=starttime%></td>
								</tr>
								<%
							...
							<form action="trainqueryresult1.jsp" method="get">
								<%
									if (Page != 1) {
										out.print(" <a href=trainqueryresult1.jsp?Page=1>第一页</a>");
										out.print(" <a href=trainqueryresult1.jspPage=" + (Page - 1)
												+ ">上一页</a>");
									}
									if (Page != totalPage) {
										out.print(" <a href=trainqueryresult1.jsp?Page=" + (Page + 1)
												+ ">下一页</a>");
										out.print(" <a href=trainqueryresult1.jsp?Page=" + totalPage
												+ ">最后一页</a>");
									}
								%>
