				...
				<div id="container" class="box">
					...
					<div id="obsah" class="content box">
						<div class="in">
							...
							<form action="addressqueryresult.jsp" method="get">
								<%
									if (Page != 1) {
										out.print(" <a href=addressqueryresult.jsp?Page=1>第一页</a>");
										out.print(" <a href=addressqueryresult.jspPage=" + (Page - 1)
												+ ">上一页</a>");
									}
									if (Page != totalPage) {
										out.print(" <a href=addressqueryresult.jsp?Page=" + (Page + 1)
												+ ">下一页</a>");
										out.print(" <a href=addressqueryresult.jsp?Page=" + totalPage
												+ ">最后一页</a>");
									}
								%>
									...
									<td>
										...
										<table width="120" border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td>
													<div align="center">
														<b> <a href="userlogin.jsp"> <!--Button1-->用户登录</a> </b>
													</div>
												</td>
											</tr>
										</table>
										...
										<table width="120" border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td>
													<div align="center">
														<b> <a href="adminlogin.jsp"> 管理员登录</a> </b>
													</div>
												</td>
											</tr>
										</table>
										...
										<table width="120" border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td>
													<div align="center">
														<b> <a href="trainquery.jsp"> 按车次查询</a> </b>
													</div>
												</td>
											</tr>
										</table>
										...
										<table width="120" border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td>
													<div align="center">
														<b> <a href="addressquery.jsp"> 按地点查询</a> </b>
													</div>
												</td>
											</tr>
										</table>
										...
										<table width="120" border="0" cellspacing="0" cellpadding="0"
											...
											<tr>
												<td>
													<div align="center">
														<b> <a href="stationquery.jsp"> 按站点查询</a> </b>
													</div>
												</td>
											</tr>
										</table>
